...
function normalizeSnapshot(value) {
  ...
  return {
    ...
    ...isRecord(source.humanizeDefaults) ? { humanizeDefaults: source.humanizeDefaults } : {}
  };
}
...
// plugin-src/client/channels/shared/humanize-fields.js
...
var SHIPPED_HUMANIZE_DEFAULTS = Object.freeze({
  streaming: true,
  messageBreak: true,
  statusReaction: true,
  replyQuote: true,
...
function resolvedHumanizeDefaults(humanizeDefaults) {
  return humanizeDefaults && typeof humanizeDefaults === "object" ? { ...SHIPPED_HUMANIZE_DEFAULTS, ...humanizeDefaults } : { ...SHIPPED_HUMANIZE_DEFAULTS };
}
...
function validateSendDelayDraft(draft) {
...
function validateBurstDraft(draft) {
...
function FieldErrorText({ errors, field }) {
  ...
  return h2("span", { className: "dim-sendDelayFieldError", role: "alert" }, errors[field]);
}
...
function SendDelayPresetSelect({ value, disabled = false, onChange }) {
  return h2(
    "select",
    {
...
function TypingBurstFields({ draft, busy = false, errors = null, onField }) {
  const errorOf = (field) => errors?.[field] ? h2(FieldErrorText, { errors, field }) : null;
  return h2(
    "div",
    ...
    h2(
      ...
      h2("span", { className: "dim-sendDelayRangeName" }, "\u4EAE\u76F8\uFF08\u6BEB\u79D2\uFF09"),
      h2(
        "span",
    ...
    h2(
      "div",
      { className: "dim-sendDelayRange" },
      h2("span", { className: "dim-sendDelayRangeName" }, "\u706D\u76F8\uFF08\u6BEB\u79D2\uFF09"),
      h2(
        "span",
        { className: "dim-sendDelayRangeInputs" },
        h2("input", {
...
function SendDelayFields({ draft, busy = false, errors = null, onField }) {
  const errorOf = (field) => errors?.[field] ? h2(FieldErrorText, { errors, field }) : null;
  return h2(
    "div",
    { className: "dim-sendDelayFields" },
...
var BOOLEAN_KEYS = ["streaming", "messageBreak", "statusReaction", "replyQuote", "progressStatus"];
var ENUM_KEYS = ["onNewMessage", "typingIndicator"];
var ALL_KEYS = [...BOOLEAN_KEYS, ...ENUM_KEYS, "typingBurst", "sendDelay"];
function deriveDraft(humanize, defaults) {
  ...
  for (const key of BOOLEAN_KEYS) {
    draft[key] = ov[key] !== void 0 ? ov[key] ? "true" : "false" : "";
  }
  for (const key of ENUM_KEYS) {
    draft[key] = ov[key] !== void 0 ? ov[key] : "";
  }
  draft.typingBurst = {
    custom: ov.typingBurst !== void 0,
    fields: burstDraftFrom(ov.typingBurst !== void 0 ? ov.typingBurst : base.typingBurst)
  };
  const sdConfig = ov.sendDelay !== void 0 ? ov.sendDelay : base.sendDelay;
  draft.sendDelay = {
    custom: ov.sendDelay !== void 0,
...
function countOverrides(humanize) {
  ...
  return ALL_KEYS.filter((key) => humanize[key] !== void 0).length;
}
...
function BotHumanizeEditor({
  ...
  const [presetKey, setPresetKey] = React10.useState("");
  const [draft, setDraft] = React10.useState(() => deriveDraft(humanize, humanizeDefaults));
  ...
  const draftHasCustom = BOOLEAN_KEYS.some((key) => draft[key] !== "") || ENUM_KEYS.some((key) => draft[key] !== "") || draft.typingBurst.custom || draft.sendDelay.custom;
  return h2(
    "div",
    ...
    h2(
      ...
      h2("span", { className: "dim-sendDelayToggleLabel" }, "\u62DF\u4EBA\u5316"),
      h2("span", {
    ...
    open ? h2(
      ...
      ...BOOLEAN_KEYS.map((key) => {
        ...
        return h2(
          "label",
          { key, className: "dim-humanizeField dim-sendDelayField" },
          h2(
            "span",
            { className: "dim-humanizeFieldRow" },
            h2(
              ...
              h2("option", { value: "true" }, "\u5F00\u542F"),
              h2("option", { value: "false" }, "\u5173\u95ED")
            ),
            h2("span", { className: "dim-humanizeFieldName" }, meta.label)
          ),
          h2("span", { className: "dim-humanizeFieldHint" }, meta.hint)
        );
      }),
      ...
      h2(
        ...
        h2(
          ...
          h2(
            ...
            HUMANIZE_SETTING_META.onNewMessage.options.map((option) => h2("option", { key: option.value, value: option.value }, option.label))
          ),
          h2("span", { className: "dim-humanizeFieldName" }, HUMANIZE_SETTING_META.onNewMessage.label)
        ),
        h2("span", { className: "dim-humanizeFieldHint" }, HUMANIZE_SETTING_META.onNewMessage.hint)
      ),
      ...
      h2(
        ...
        h2(
          ...
          h2(
            ...
            HUMANIZE_SETTING_META.typingIndicator.options.map((option) => h2("option", { key: option.value, value: option.value }, option.label))
          ),
          h2("span", { className: "dim-humanizeFieldName" }, HUMANIZE_SETTING_META.typingIndicator.label)
        ),
        h2("span", { className: "dim-humanizeFieldHint" }, HUMANIZE_SETTING_META.typingIndicator.hint)
      ),
      ...
      h2(
        ...
        h2(
          ...
          h2("span", { className: "dim-humanizeFieldName" }, "\u65AD\u7EED\u8282\u594F")
        ),
        draft.typingBurst.custom ? h2(TypingBurstFields, {
          ...
          "span",
          { className: "dim-humanizeFieldHint" },
          `\u8DDF\u968F\u5168\u5C40\uFF08${defaults.typingBurst.onMinMs}\u2013${defaults.typingBurst.onMaxMs} / ${defaults.typingBurst.offMinMs}\u2013${defaults.typingBurst.offMaxMs} \u6BEB\u79D2\uFF09`
        )
      ),
      ...
      h2(
        ...
        h2(
          ...
          h2("span", { className: "dim-humanizeFieldName" }, "\u53D1\u9001\u5EF6\u8FDF")
        ),
        draft.sendDelay.custom ? h2(
          "div",
          { className: "dim-sendDelayFields" },
          h2(SendDelayPresetSelect, {
            value: presetKey,
            disabled: busy,
...
function createTokenChannelApi(channel4, connectionSummary, {
  ...
  const normalizeSnapshot9 = (value) => {
    ...
    return {
      ...
      agentPresetCatalog: normalizeAgentPresetCatalog(source.agentPresetCatalog),
      modelCatalog: normalizeModelCatalog(source.modelCatalog),
      ...isRecord2(source.humanizeDefaults) ? { humanizeDefaults: source.humanizeDefaults } : {}
    };
  };
...
function normalizeBotsSnapshot(value) {
  ...
  return {
    ...
    ...isRecord3(value.humanizeDefaults) ? { humanizeDefaults: value.humanizeDefaults } : {}
  };
}
...
function normalizeSnapshot3(value) {
  ...
  return {
    ...
    agentPresetCatalog: normalizeAgentPresetCatalog(source.agentPresetCatalog),
    modelCatalog: normalizeModelCatalog(source.modelCatalog),
    ...isRecord4(source.humanizeDefaults) ? { humanizeDefaults: source.humanizeDefaults } : {},
...
function normalizeSnapshot6(value) {
  ...
  return {
    ...
    agentPresetCatalog: normalizeAgentPresetCatalog(source.agentPresetCatalog),
    modelCatalog: normalizeModelCatalog(source.modelCatalog),
    ...isRecord5(source.humanizeDefaults) ? { humanizeDefaults: source.humanizeDefaults } : {}
  };
}
...
function normalizeSnapshot7(value) {
  ...
  return {
    ...
    agentPresetCatalog: normalizeAgentPresetCatalog(value.agentPresetCatalog),
    ...isRecord6(value.humanizeDefaults) ? { humanizeDefaults: value.humanizeDefaults } : {},
    modelCatalog: normalizeModelCatalog(value.modelCatalog)
  };
}
...
function normalizeSnapshot8(value) {
  ...
  return {
    ...
    agentPresetCatalog: normalizeAgentPresetCatalog(source.agentPresetCatalog),
    modelCatalog: normalizeModelCatalog(source.modelCatalog),
    ...isRecord7(source.humanizeDefaults) ? { humanizeDefaults: source.humanizeDefaults } : {}
  };
}
...
var BOOLEAN_SETTING_KEYS = ["streaming", "messageBreak", "statusReaction", "replyQuote", "progressStatus"];
...
function HumanizeSettingsPanel({ rpcCall }) {
  ...
  const [sdDraft, setSdDraft] = React27.useState(() => draftFromConfig(null));
  const [burstDraft, setBurstDraft] = React27.useState(() => burstDraftFrom(null));
  const [fieldErrors, setFieldErrors] = React27.useState(null);
  ...
  const save = async () => {
    ...
    try {
      ...
      if (caught instanceof FieldError) {
        ...
        setSaveError(presentError12(caught, "\u914D\u7F6E\u65E0\u6548\uFF0C\u8BF7\u68C0\u67E5\u540E\u91CD\u8BD5\u3002"));
      }
      return;
    }
    saving.current = true;
  ...
  return h2(
    ...
    h2(
      ...
      ...BOOLEAN_SETTING_KEYS.map((key) => {
        ...
        return h2(
          "label",
          { key, className: "dim-humanizeField" },
          h2(
            "span",
            { className: "dim-humanizeFieldRow" },
            h2("input", {
      ...
      h2(
        ...
        h2(
          ...
          HUMANIZE_SETTING_META.onNewMessage.options.map(
      ...
      h2(
        ...
        h2(
          ...
          HUMANIZE_SETTING_META.typingIndicator.options.map(
            (opt) => h2("option", { key: opt.value, value: opt.value }, opt.label)
          )
        ),
        h2("span", { className: "dim-humanizeFieldHint" }, HUMANIZE_SETTING_META.typingIndicator.hint)
