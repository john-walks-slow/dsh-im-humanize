...
function GlobalSettingsPanel({ rpcCall }) {
  ...
  const [saveSucceeded, setSaveSucceeded] = React22.useState(false);
  const [isSaving, setIsSaving] = React22.useState(false);
  ...
  const sweepTriggerId = React22.useId();
  const sweepConfirmId = React22.useId();
  const sweepConfirmTextId = React22.useId();
  const sweepConfirmButtonId = React22.useId();
...
function IMSettingsTab({
  ...
  const generalSettingsTooltipId = React24.useId();
