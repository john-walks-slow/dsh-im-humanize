...
var IDLE_BOOST_MULTIPLIER_MIN = 1;
var IDLE_BOOST_MULTIPLIER_MAX = 10;
var IDLE_BOOST_AFTER_MS_MAX = 864e5;
var DEFAULT_READ_DELAY = Object.freeze({
  minMs: 1e3,
  maxMs: 6e3,
  charsPerSecond: 0,
  maxTotalMs: 3e4,
  idleBoost: Object.freeze({ afterMs: 6e5, multiplier: 2 })
});
...
function normalizeSendDelayConfig(partial) {
  ...
  readDelay.idleBoost = normalizeIdleBoost(
    source.readDelay?.idleBoost && typeof source.readDelay.idleBoost === "object" ? source.readDelay.idleBoost : DEFAULT_READ_DELAY.idleBoost
  );
...
var IDLE_AFTER_MAX_MINUTES = 1440;
var IDLE_MULTIPLIER_MAX = 10;
  ...
  return h2(
    ...
    open ? h2(
      ...
      mode === "override" ? h2(
        ...
        h2(
          "div",
          { className: "dim-sendDelayRange dim-sendDelayIdleBoost" },
          h2("span", { className: "dim-sendDelayRangeName" }, "\u95F2\u7F6E\u52A0\u6210"),
          h2(
            "span",
            { className: "dim-sendDelayRangeInputs" },
            h2("input", {
            ...
            h2("span", { className: "dim-sendDelayRangeSep", "aria-hidden": "true" }, "\u5206\u949F \u2192 \u5EF6\u8FDF \xD7"),
            h2("input", {
              type: "number",
              min: 1,
              max: IDLE_MULTIPLIER_MAX,
...
var IDLE_AFTER_MAX_MINUTES2 = 1440;
var IDLE_MULTIPLIER_MAX2 = 10;
...
var SEND_DELAY_PRESETS = Object.freeze([
  {
    ...
    config: {
      enabled: true,
      readDelay: { minMs: 1e3, maxMs: 6e3, charsPerSecond: 0, maxTotalMs: 3e4, idleBoost: { afterMs: 6e5, multiplier: 2 } },
  ...
  },
  {
    ...
    config: {
      enabled: true,
      readDelay: { minMs: 5e3, maxMs: 15e3, charsPerSecond: 12, maxTotalMs: 6e4, idleBoost: { afterMs: 3e5, multiplier: 2.5 } },
  ...
  },
  {
    ...
    config: {
      enabled: true,
      readDelay: { minMs: 8e3, maxMs: 3e4, charsPerSecond: 8, maxTotalMs: 12e4, idleBoost: { afterMs: 3e5, multiplier: 3 } },
  ...
  },
  {
    ...
    config: {
      enabled: true,
      readDelay: { minMs: 0, maxMs: 500, charsPerSecond: 0, maxTotalMs: 3e4, idleBoost: { afterMs: 6e5, multiplier: 1 } },
...
function HumanizeSettingsPanel({ rpcCall }) {
  ...
  const updateIdleAfterMs = (minutes) => {
    ...
    const ms = Number.isFinite(numeric) && numeric > 0 ? Math.round(numeric * 6e4) : 0;
    setSettings((prev) => ({
      ...prev,
      sendDelay: {
        ...prev.sendDelay,
  ...
  return h2(
    ...
    h2(
      ...
      h2(
        "div",
        { className: "dim-humanizeRangeRow" },
        h2("span", { className: "dim-humanizeRangeName" }, "\u95F2\u7F6E\u52A0\u6210"),
        h2(
          "span",
          { className: "dim-humanizeRangeInputs" },
          h2("span", { className: "dim-humanizeRangeName" }, "\u95F2\u7F6E \u2265"),
          h2("input", {
            type: "number",
            min: 0,
            max: IDLE_AFTER_MAX_MINUTES2,
            step: 1,
            value: String(minutesInputValue(settings.sendDelay?.readDelay?.idleBoost?.afterMs)),
            "aria-label": "\u95F2\u7F6E\u9608\u503C\uFF08\u5206\u949F\uFF09",
            onChange: (e) => updateIdleAfterMs(e.target.value)
          }),
          h2("span", { className: "dim-humanizeRangeSep", "aria-hidden": "true" }, "\u5206\u949F \u2192 \u5EF6\u8FDF \xD7"),
          h2("input", {
            type: "number",
            min: 1,
            max: IDLE_MULTIPLIER_MAX2,
            step: 0.5,
