...
var EN = Object.freeze({
  ...
  "\u53EA\u5F71\u54CD\u4E4B\u540E\u65B0\u5EFA\u7684\u4F1A\u8BDD\u3002": "Only later new sessions use this preset.",
...
function AgentPresetEditor({ agentPreset = "", disabled = false, onSave }) {
  ...
  return h2(
    ...
    h2("small", { className: "dim-presetHelp" }, "\u53EA\u5F71\u54CD\u4E4B\u540E\u65B0\u5EFA\u7684\u4F1A\u8BDD\u3002"),
    error ? h2("p", { className: "dim-presetError", role: "alert" }, error) : null
  );
}
