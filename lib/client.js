...
var EN = Object.freeze({
  ...
  "\u4F8B\u5982 wwd9c0128d127xxxxx": "for example wwd9c0128d127xxxxx",
  "\u5E94\u7528 AgentId": "AgentId",
  ...
  "\u4F8B\u5982 https://dsh.curi.cc": "for example https://dsh.curi.cc",
  "\u4F8B\u5982 https://dsh.curi.cc\uFF0C\u7528\u4E8E\u5C55\u793A\u5B8C\u6574\u56DE\u8C03 URL": "for example https://dsh.curi.cc, used to display the full callback URL",
    ...
    h2(
      ...
      ...catalog.groups.map((group) => h2(
        ...
        ...group.models.map((entry) => {
          const selection = { provider: group.id, model: entry.id };
          const id6 = modelSelectionId(selection);
          return h2(
            "option",
            { key: id6, value: optionValue(selection) },
            entry.name && entry.name !== entry.id ? `${entry.name}\uFF08${id6}\uFF09` : id6
          );
        })
      )),
  ...
  return h2(
    ...
    h2(
      ...
      h2(
        ...
        h2(Field, { label: "\u4F01\u4E1A ID\uFF08CorpID\uFF09", value: corpId, onChange: setCorpId, placeholder: "\u4F8B\u5982 wwd9c0128d127xxxxx", busy, required: true }),
      ...
      h2(
        "div",
        { className: "dim-appFieldGrid" },
        h2(Field, { label: "\u516C\u7F51\u56DE\u8C03\u57FA\u5740\uFF08\u53EF\u9009\uFF09", value: callbackBaseUrl, onChange: setCallbackBaseUrl, placeholder: "\u4F8B\u5982 https://dsh.curi.cc\uFF0C\u7528\u4E8E\u5C55\u793A\u5B8C\u6574\u56DE\u8C03 URL", busy }),
        h2(
          "div",
      ...
      h2(
        "div",
        { className: "ddt-actions dim-viewActions" },
        h2(Button12, { kind: "primary", type: "submit", disabled: busy }, busy ? "\u6B63\u5728\u7ED1\u5B9A\u2026" : "\u4FDD\u5B58\u5E76\u8FDE\u63A5"),
...
function AppSettingsEditor({ bot, busy, onSave }) {
  ...
  return h2(
    "form",
    { className: "dim-appFieldGrid", onSubmit: save },
    ...
    h2(Field, { label: "\u516C\u7F51\u56DE\u8C03\u57FA\u5740\uFF08\u53EF\u9009\uFF09", value: callbackBaseUrl, onChange: (value) => {
      ...
      touch();
    }, placeholder: "\u4F8B\u5982 https://dsh.curi.cc", busy }),
    h2(
      "div",
      { className: "dim-appSwitchRow" },
      h2("button", {
    ...
    h2(
      "div",
      { className: "ddt-actions dim-viewActions" },
      h2(Button12, { type: "submit", disabled: busy || !dirty }, busy ? "\u4FDD\u5B58\u4E2D\u2026" : "\u4FDD\u5B58\u8BBE\u7F6E")
    )
  );
}
