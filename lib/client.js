...
function HumanizeSettingsPanel({ rpcCall }) {
  ...
  if (phase === "loading") {
    return h2(
      "div",
      { className: "dim-humanizeSettings dim-humanizeSettings--loading" },
      h2("p", null, "\u6B63\u5728\u52A0\u8F7D\u2026")
    );
  }
  if (phase === "error") {
    return h2(
      "div",
      { className: "dim-humanizeSettings dim-humanizeSettings--error" },
      h2("p", { role: "alert" }, loadError),
      h2("button", {
        type: "button",
        className: "dim-humanizeRetry",
  ...
  if (!settings) {
    return h2(
      "div",
      { className: "dim-humanizeSettings" },
      h2("p", null, "\u6682\u65E0\u53EF\u7528\u8BBE\u7F6E\u3002")
    );
  }
  ...
  return h2(
    ...
    h2(
      "p",
      { className: "dim-humanizeSettings__desc" },
    ...
    h2(
      ...
      h2(
        "label",
        { className: "dim-humanizeField__label" },
        h2("input", {
          type: "checkbox",
        ...
        h2(
          "span",
          { className: "dim-humanizeField__hint" },
    ...
    h2(
      ...
      h2(
        ...
        h2("span", null, "\u5206\u6B65\u6D88\u606F (message_break)"),
        h2(
          "span",
          { className: "dim-humanizeField__hint" },
    ...
    h2(
      ...
      h2("button", {
        type: "button",
        className: "dim-humanizeSave",
        disabled: isSaving,
        onClick: () => void save()
      }, isSaving ? "\u4FDD\u5B58\u4E2D\u2026" : "\u4FDD\u5B58"),
      saveSucceeded ? h2("span", { className: "dim-humanizeSuccess", role: "status" }, "\u5DF2\u4FDD\u5B58") : null,
      saveError ? h2("span", { className: "dim-humanizeError", role: "alert" }, saveError) : null
    )
  );
}
