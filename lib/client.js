  ...
  function SettingsTab({ rpcCall }) {
    ...
    return h4(
      ...
      model.phase === "loading" ? h4("div", {
        ...
        "aria-busy": "true"
      }, h4("div", { className: "ddt-spinner dim-spinner" }), `\u6B63\u5728\u8BFB\u53D6 ${channel4} \u673A\u5668\u4EBA\u72B6\u6001\u2026`) : model.phase === "error" ? h4(
        "div",
        { className: "ddt-card dim-surfaceCard" },
        h4(
          "div",
          { className: "ddt-inlineError dim-inlineError" },
          h4("h3", null, `\u65E0\u6CD5\u8BFB\u53D6 ${channel4} \u673A\u5668\u4EBA\u72B6\u6001`),
          ...
          h4(
            ...
            h4(
              ...
              h4(
                ...
                h4("span", null, `\u5C1A\u672A\u63A5\u5165 ${channel4} \u673A\u5668\u4EBA`)
              ),
...
function SlackCredentialPanel({ busy, error, onSubmit, onCancel }) {
  const [botToken, setBotToken] = React8.useState("");
  const [appToken, setAppToken] = React8.useState("");
  const [copied, setCopied] = React8.useState(false);
  const headingId = React8.useId();
  ...
  return h7(
    ...
    h7("h3", { id: headingId, className: "dim-credentialTitle" }, "\u63A5\u5165 Slack \u673A\u5668\u4EBA"),
    h7(
      "div",
      { className: "dsl-guide" },
      h7(
        ...
        h7("strong", null, "\u5148\u7528 Manifest \u521B\u5EFA\u5E76\u914D\u7F6E Slack App"),
        h7("p", null, "\u590D\u5236\u914D\u7F6E\u540E\uFF0C\u5728 Slack \u9009\u62E9 From a manifest\uFF1B\u521B\u5EFA\u5B8C\u6210\u540E\u751F\u6210 connections:write App Token\uFF0C\u5E76\u5C06\u5E94\u7528\u5B89\u88C5\u5230\u5DE5\u4F5C\u533A\u3002")
      ),
      h7(
        "div",
        ...
        h7("button", {
          ...
          disabled: busy
        }, copied ? h7("span", { className: "dsl-copyState" }, "\u5DF2\u590D\u5236 Manifest") : "\u590D\u5236 Manifest"),
        h7("a", {
          className: "ddt-button",
    ...
    h7(
      ...
      h7(
        ...
        h7("p", { className: "dsl-tokenHint" }, "Bot Token \u6765\u81EA OAuth & Permissions\uFF1BApp Token \u6765\u81EA Basic Information\uFF0C\u5E76\u4E14\u5FC5\u987B\u5305\u542B connections:write\u3002")
      ),
      error ? h7("p", { className: "dim-credentialError", role: "alert" }, error.message ?? String(error)) : null,
      h7(
        "div",
        { className: "ddt-actions dim-viewActions dim-credentialActions" },
        h7("button", {
...
var Button9 = React9.forwardRef(function Button10({ children, kind = "secondary", className = "", ...props }, ref) {
  return h8("button", {
    ...props,
    ref,
    type: "button",
  ...
  return h8(
    ...
    h8(
      ...
      h8(
        ...
        }, h8(CredentialActionIcon), credentialOpen ? "\u6536\u8D77\u51ED\u636E" : "\u624B\u52A8\u63A5\u5165")
      ),
...
function LoadingView4() {
  return h8(
    "div",
    { className: "ddt-card ddt-loading dim-surfaceCard dim-loadingView", "aria-busy": "true" },
    h8("div", { className: "ddt-spinner dim-spinner" }),
    h8("span", null, "\u6B63\u5728\u8BFB\u53D6\u4F01\u4E1A\u5FAE\u4FE1\u673A\u5668\u4EBA\u72B6\u6001\u2026")
  );
}
    ...
    h8(
      ...
      h8(
        ...
        h8(
          "div",
          { className: "ddt-stateLabel dim-stateLabel" },
          h8("span", { className: "ddt-dot dim-stateDot" }),
          h8("span", null, "\u5C1A\u672A\u7ED1\u5B9A\u4F01\u4E1A\u5FAE\u4FE1\u673A\u5668\u4EBA")
        ),
        h8("h3", null, "\u4F7F\u7528\u4F01\u4E1A\u5FAE\u4FE1 App \u626B\u7801\u521B\u5EFA\u667A\u80FD\u673A\u5668\u4EBA"),
        h8("p", null, "\u626B\u7801\u7531\u817E\u8BAF\u5B98\u65B9\u9875\u9762\u5B8C\u6210\uFF0C\u4E0D\u9700\u8981\u624B\u52A8\u586B\u5199 Bot ID \u6216 Secret\u3002\u521B\u5EFA\u6210\u529F\u540E\uFF0C\u673A\u5668\u4EBA\u4F1A\u81EA\u52A8\u8FDE\u63A5 DeepSeek Harness\u3002"),
        h8(
          "div",
          { className: "ddt-actions dim-viewActions" },
          h8(
    ...
    h8(
      ...
      h8(
        ...
        h8(
          "div",
          { className: "ddt-qrFrame dim-qrFrame" },
          source ? h8("img", { src: source, alt: "\u7528\u4E8E\u7ED1\u5B9A\u4F01\u4E1A\u5FAE\u4FE1\u673A\u5668\u4EBA\u7684\u4E00\u6B21\u6027\u4E8C\u7EF4\u7801" }) : h8(
            "div",
            { className: "ddt-qrFallback dim-qrFallback" },
            refreshing ? "\u4E8C\u7EF4\u7801\u6B63\u5728\u81EA\u52A8\u5237\u65B0\u2026" : "\u4E8C\u7EF4\u7801\u56FE\u7247\u6B63\u5728\u751F\u6210\u2026"
          )
        ...
        h8(
          ...
          h8(
            "div",
            { className: "ddt-countdownTop dim-countdownTop" },
            h8("span", null, "\u5F53\u524D\u4E8C\u7EF4\u7801\u6709\u6548\u65F6\u95F4"),
            h8("strong", null, refreshing ? "--:--" : formatRemaining4(remaining))
          ),
          h8("div", { className: "ddt-progress dim-progress", style: { "--ddt-progress": `${progress}%` } }, h8("span"))
        )
      ),
      h8(
        "div",
        ...
        h8(
          "div",
          { className: "ddt-stateLabel dim-stateLabel" },
          h8("span", { className: "ddt-dot dim-stateDot", "data-tone": "warning" }),
          h8("span", null, refreshing ? "\u6B63\u5728\u5237\u65B0\u4E8C\u7EF4\u7801" : "\u7B49\u5F85\u4F01\u4E1A\u5FAE\u4FE1 App \u626B\u7801")
        ),
        h8("h3", null, "\u4F7F\u7528\u4F01\u4E1A\u5FAE\u4FE1 App \u5B8C\u6210\u667A\u80FD\u673A\u5668\u4EBA\u6388\u6743"),
        h8("p", null, "\u4F01\u4E1A\u5FAE\u4FE1\u5B98\u65B9\u9875\u9762\u4F1A\u521B\u5EFA\u4E00\u4E2A\u667A\u80FD\u673A\u5668\u4EBA\uFF0C\u5E76\u628A\u8FDE\u63A5\u51ED\u636E\u5B89\u5168\u4EA4\u7ED9\u672C\u673A Harness Host\u3002"),
        h8(
          "ol",
          { className: "ddt-steps dim-steps" },
          h8("li", null, "\u6253\u5F00\u4F01\u4E1A\u5FAE\u4FE1 App\uFF0C\u626B\u63CF\u5DE6\u4FA7\u4E8C\u7EF4\u7801"),
          h8("li", null, "\u5728\u817E\u8BAF\u6388\u6743\u9875\u9762\u786E\u8BA4\u521B\u5EFA\u667A\u80FD\u673A\u5668\u4EBA"),
          h8("li", null, "\u8FD4\u56DE\u8FD9\u91CC\u7B49\u5F85\u8FDE\u63A5\u5B8C\u6210")
        ),
        h8(
          "div",
          { className: "ddt-actions dim-viewActions" },
          h8(Button9, { onClick: onRefresh, disabled: busy }, "\u91CD\u65B0\u751F\u6210\u4E8C\u7EF4\u7801"),
          h8(Button9, { kind: "quiet", onClick: onCancel, disabled: busy }, "\u53D6\u6D88")
        )
      )
    )
  );
...
function ProvisionView2({ provision, busy, onRetry, onClose }) {
  if (provision.status === "connecting") {
    return h8(
      ...
      { className: "ddt-card ddt-loading dim-surfaceCard dim-specialView", "aria-busy": "true" },
      h8("div", { className: "ddt-spinner dim-spinner" }),
      h8("h3", null, "\u4F01\u4E1A\u5FAE\u4FE1\u5DF2\u6388\u6743\uFF0C\u6B63\u5728\u8FDE\u63A5\u673A\u5668\u4EBA"),
      h8("p", null, "\u51ED\u636E\u6B63\u5728\u5199\u5165\u672C\u673A\uFF0C\u5E76\u542F\u52A8\u4F01\u4E1A\u5FAE\u4FE1 WebSocket \u6D88\u606F\u8FDE\u63A5\u3002")
    );
  }
  ...
  return h8(
    ...
    h8(
      "div",
      { className: "ddt-inlineError dim-inlineError", role: "alert" },
      h8("h3", null, "\u4F01\u4E1A\u5FAE\u4FE1\u673A\u5668\u4EBA\u6CA1\u6709\u7ED1\u5B9A\u5B8C\u6210"),
      h8("p", null, error.message),
      h8("span", { className: "ddt-errorCode" }, error.code),
      h8(
        "div",
        { className: "ddt-actions dim-viewActions" },
        h8(Button9, { kind: "primary", onClick: onRetry, disabled: busy }, "\u91CD\u65B0\u751F\u6210\u4E8C\u7EF4\u7801"),
        h8(Button9, { onClick: onClose, disabled: busy }, "\u5173\u95ED")
      )
    )
  );
}
function RemoveConfirmation4({ account, busy, onConfirm, onCancel }) {
  return h8(
    "div",
    { className: "ddt-confirm dim-confirm", role: "alertdialog" },
    h8("strong", null, `\u4ECE DeepSeek Harness \u79FB\u9664\u201C${account.bot.name}\u201D\uFF1F`),
    h8("p", null, "\u8FD9\u4F1A\u505C\u6B62\u6D88\u606F\u8FDE\u63A5\uFF0C\u5E76\u5220\u9664\u672C\u673A\u4FDD\u5B58\u7684\u5E94\u7528\u51ED\u636E\u3001\u673A\u5668\u4EBA\u914D\u7F6E\u53CA\u4F1A\u8BDD\u6620\u5C04\u3002\u4F01\u4E1A\u5FAE\u4FE1\u5E73\u53F0\u4E2D\u7684\u673A\u5668\u4EBA\u4E0D\u4F1A\u88AB\u81EA\u52A8\u5220\u9664\u3002"),
    h8(
      "div",
      { className: "ddt-actions dim-viewActions" },
      h8(Button9, { onClick: onCancel, disabled: busy }, "\u4FDD\u7559\u673A\u5668\u4EBA"),
      h8(Button9, { kind: "danger", onClick: onConfirm, disabled: busy }, busy ? "\u6B63\u5728\u79FB\u9664\u2026" : "\u786E\u8BA4\u79FB\u9664\u63A5\u5165")
    )
  );
}
    ...
    h8(
      ...
      h8(
        ...
        h8(
          "div",
          { className: "ddt-accountIdentity dim-botIdentity" },
          h8("div", { className: "ddt-avatar dim-botAvatar dwecom-avatar", "aria-hidden": "true" }, h8(WecomLogoGlyph, { size: 29 })),
          h8(
            "div",
            { className: "dim-botName" },
            h8("h3", null, account.bot.name),
            h8("p", null, account.bot.appIdMasked)
          )
        ),
        h8(
          "div",
          { className: "ddt-health dim-botHealth" },
          h8("span", { className: "ddt-dot dim-healthDot", "data-tone": tone }),
          h8("span", null, stateLabel)
        )
      ),
      h8(
        "dl",
        { className: "ddt-metrics dim-botMetrics" },
        h8("div", { className: "ddt-metric dim-botMetric" }, h8("dt", null, "\u6D88\u606F\u901A\u9053"), h8("dd", null, account.connected ? "WebSocket \u957F\u8FDE\u63A5" : "\u79BB\u7EBF")),
        h8("div", { className: "ddt-metric dim-botMetric" }, h8("dt", null, "\u6700\u8FD1\u68C0\u67E5"), h8("dd", null, checkedTime4(account.health.lastCheckedAt)))
      ),
      h8(
        "div",
        { className: "ddt-accountFooter dim-cardFooter" },
        summary ? h8("div", { className: "ddt-summary dim-cardSummary" }, summary) : null,
        h8(
          "div",
          { className: "ddt-actions dim-cardActions" },
          h8(Button9, { className: "dim-cardAction", onClick: onReconnect, disabled: Boolean(busy) }, busy === "reconnect" ? "\u68C0\u67E5\u4E2D\u2026" : account.connected ? "\u68C0\u67E5\u8FDE\u63A5" : "\u91CD\u8BD5\u8FDE\u63A5"),
          h8(Button9, { className: "dim-cardAction", kind: "danger", onClick: onRequestRemove, disabled: Boolean(busy) }, "\u79FB\u9664\u63A5\u5165")
        )
      )
    ),
    removing ? h8(RemoveConfirmation4, {
      account,
      busy: busy === "delete",
      onConfirm: onConfirmRemove,
      onCancel: onCancelRemove
...
function WecomSettingsTab({ rpcCall }) {
  const [model, setModel] = React9.useState({ phase: "loading", bots: [], totals: { configured: 0, connected: 0 }, error: null });
  ...
  let provisionView = null;
  if (provision?.status === "starting") provisionView = h8("div", { className: "ddt-card ddt-loading dim-surfaceCard" }, h8("div", { className: "ddt-spinner" }), "\u6B63\u5728\u7533\u8BF7\u4F01\u4E1A\u5FAE\u4FE1\u4E8C\u7EF4\u7801\u2026");
  else if (["pending", "refreshing"].includes(provision?.status)) provisionView = h8(QrPanel3, {
    provision,
    now,
    busy,
    onRefresh: () => void startProvisioning(true),
  ...
  else if (provision) provisionView = h8(ProvisionView2, {
    provision,
    busy,
    onRetry: () => void startProvisioning(true),
    onClose: () => void closeProvision()
  });
  const botList = model.bots.length > 0 ? h8(
    "section",
    { className: "dim-listSection" },
    h8(
      "div",
      { className: "ddt-listHeading dim-listHeading" },
      h8("h3", null, "\u5DF2\u7ED1\u5B9A\u7684\u4F01\u4E1A\u5FAE\u4FE1\u673A\u5668\u4EBA")
    ),
    h8("ul", { className: "ddt-list dim-botList" }, model.bots.map((account) => h8("li", { key: account.botId }, h8(AccountCard3, {
      account,
      busy: busyByBot[account.botId],
      removing: removeTarget === account.botId,
  ...
  const credentialView = credentialOpen ? h8(CredentialBindingPanel, {
    channel: "\u4F01\u4E1A\u5FAE\u4FE1",
  ...
  return h8(
    ...
    model.phase === "loading" ? h8(LoadingView4) : model.phase === "error" ? h8("div", { className: "ddt-card dim-surfaceCard" }, h8("div", { className: "ddt-inlineError dim-inlineError" }, h8("h3", null, "\u65E0\u6CD5\u8BFB\u53D6\u4F01\u4E1A\u5FAE\u4FE1\u673A\u5668\u4EBA\u72B6\u6001"), h8("p", null, model.error?.message), h8(Button9, { onClick: () => void loadStatus() }, "\u91CD\u65B0\u8BFB\u53D6"))) : h8(
      React9.Fragment,
      null,
      credentialView,
      provisionView,
      model.bots.length === 0 && !provision && !credentialOpen ? h8(EmptyView4, { busy, onStart: () => void startProvisioning() }) : null,
      botList
    )
  );
}
...
var Button11 = React10.forwardRef(function Button12({ children, kind = "secondary", className = "", ...props }, ref) {
  return h9("button", {
    ...props,
    ref,
    type: "button",
...
function Heading5({ totals, adding, busy, onAdd, addButtonRef }) {
  return h9(
    ...
    h9(
      ...
      }, h9(QrActionIcon), adding ? "\u6B63\u5728\u63A5\u5165" : "\u626B\u7801\u63A5\u5165\u673A\u5668\u4EBA"),
...
function LoadingView5() {
  return h9(
    ...
    h9("div", { className: "dxw-spinner dim-spinner" }),
    h9("span", null, "\u6B63\u5728\u8BFB\u53D6\u5FAE\u4FE1\u8FDE\u63A5\u72B6\u6001\u2026")
  );
}
    ...
    h9(
      ...
      h9(
        ...
        h9(
          ...
          h9("span", { className: "dxw-dot dim-stateDot" }),
          h9("span", null, "\u5C1A\u672A\u7ED1\u5B9A\u5FAE\u4FE1")
        ),
        h9("h3", null, "\u626B\u4E00\u6B21\u7801\uFF0C\u5C31\u80FD\u5728\u5FAE\u4FE1\u91CC\u4F7F\u7528 Harness"),
        h9("p", null, "\u4E8C\u7EF4\u7801\u7531\u817E\u8BAF\u5FAE\u4FE1 iLink \u670D\u52A1\u7B7E\u53D1\u3002\u7528\u624B\u673A\u5FAE\u4FE1\u626B\u63CF\u5E76\u786E\u8BA4\u540E\uFF0C\u8D26\u53F7\u51ED\u636E\u4F1A\u76F4\u63A5\u5199\u5165 Harness Host\uFF0C\u6D4F\u89C8\u5668\u4E0D\u4F1A\u6536\u5230 bot_token\u3002"),
        h9(
          "div",
      ...
      h9("div", { className: "dxw-logo dim-emptyBrand", "aria-hidden": "true" }, h9(WeixinLogoGlyph, { size: 64 }))
    )
  );
}
    ...
    h9(
      ...
      h9(
        ...
        h9(
          ...
          source && !imageFailed ? h9("img", {
            src: source,
            alt: "\u7528\u4E8E\u628A\u5FAE\u4FE1\u673A\u5668\u4EBA\u7ED1\u5B9A\u5230 DeepSeek Harness \u7684\u4E00\u6B21\u6027\u4E8C\u7EF4\u7801",
            onError: () => setImageFailed(true)
          }) : h9("div", { className: "dxw-qrFallback dim-qrFallback" }, "\u4E8C\u7EF4\u7801\u56FE\u7247\u672A\u5C31\u7EEA\uFF0C\u8BF7\u4F7F\u7528\u5907\u7528\u94FE\u63A5\u3002"),
          expired ? h9("div", { className: "dxw-expired dim-qrExpired" }, "\u4E8C\u7EF4\u7801\u5DF2\u8FC7\u671F\n\u8BF7\u91CD\u65B0\u751F\u6210") : null
        ),
        h9(
          "div",
          { className: "dxw-countdown dim-countdown" },
          h9("div", { className: "dim-countdownTop" }, h9("span", null, "\u4E8C\u7EF4\u7801\u6709\u6548\u65F6\u95F4"), h9("strong", null, formatRemaining5(remaining))),
          h9(
            "div",
            { className: "dxw-progress dim-progress", "aria-hidden": "true" },
            h9("span", { style: { "--dxw-progress": `${progress}%` } })
          )
        )
      ),
      h9(
        ...
        h9(
          "div",
          { className: "dxw-stateLabel dim-stateLabel" },
          h9("span", { className: "dxw-dot dim-stateDot", "data-tone": provision.status === "scanned" ? "success" : "warning" }),
          h9("span", null, provision.status === "scanned" ? "\u5DF2\u626B\u7801\uFF0C\u8BF7\u5728\u624B\u673A\u4E0A\u786E\u8BA4" : "\u7B49\u5F85\u5FAE\u4FE1\u626B\u7801")
        ),
        h9("h3", null, expired ? "\u4E8C\u7EF4\u7801\u5DF2\u5931\u6548" : "\u4F7F\u7528\u624B\u673A\u5FAE\u4FE1\u626B\u63CF\u4E8C\u7EF4\u7801"),
        h9("p", null, "\u8BF7\u5728\u624B\u673A\u4E0A\u6838\u5BF9\u5E76\u786E\u8BA4\u6388\u6743\u3002\u90E8\u5206\u8D26\u53F7\u4F1A\u989D\u5916\u663E\u793A\u4E00\u4E2A\u914D\u5BF9\u6570\u5B57\uFF0C\u9875\u9762\u4F1A\u5728\u9700\u8981\u65F6\u63D0\u793A\u8F93\u5165\u3002"),
        h9(
          "ol",
          { className: "dxw-steps dim-steps" },
          h9("li", null, "\u6253\u5F00\u624B\u673A\u5FAE\u4FE1\u5E76\u626B\u63CF\u5DE6\u4FA7\u4E8C\u7EF4\u7801"),
          h9("li", null, "\u5728\u5FAE\u4FE1\u4E2D\u786E\u8BA4\u8FDE\u63A5\u8BE5\u673A\u5668\u4EBA"),
          h9("li", null, "\u4FDD\u6301\u672C\u9875\u6253\u5F00\uFF0C\u7B49\u5F85\u6D88\u606F\u957F\u8F6E\u8BE2\u53D8\u4E3A\u5728\u7EBF")
        ),
        h9(
          "div",
          { className: "dxw-actions dim-viewActions" },
          expired ? h9(Button11, { kind: "primary", onClick: onRefresh, disabled: busy }, "\u91CD\u65B0\u751F\u6210\u4E8C\u7EF4\u7801") : null,
          href ? h9("a", {
          ...
          !expired ? h9(Button11, { onClick: onRefresh, disabled: busy }, "\u6362\u4E00\u4E2A\u4E8C\u7EF4\u7801") : null,
          h9(Button11, { onClick: onCancel, disabled: busy }, "\u53D6\u6D88")
        )
      )
    )
  );
  ...
  return h9(
    ...
    h9(
      ...
      h9(
        ...
        h9("span", { className: "dxw-dot", "data-tone": "warning" }),
        h9("span", null, "\u9700\u8981\u914D\u5BF9\u7801")
      ),
      h9("h3", null, "\u8F93\u5165\u624B\u673A\u5FAE\u4FE1\u663E\u793A\u7684\u6570\u5B57"),
      h9("p", null, "\u8FD9\u662F\u5FAE\u4FE1\u9644\u52A0\u7684\u5B89\u5168\u786E\u8BA4\u6B65\u9AA4\u3002\u914D\u5BF9\u7801\u53EA\u7528\u4E8E\u672C\u6B21\u626B\u7801\u8F6E\u8BE2\uFF0C\u4E0D\u4F1A\u5199\u5165\u914D\u7F6E\u6216\u65E5\u5FD7\u3002"),
      h9(
        "div",
      ...
      h9(Button11, { onClick: onCancel, disabled: busy }, "\u53D6\u6D88\u7ED1\u5B9A")
    )
  );
}
function ProgressPanel2({ scanned, onCancel, busy }) {
  return h9(
    ...
    { className: "dxw-card dxw-loading dim-surfaceCard dim-loadingView", "aria-busy": "true" },
    h9("div", { className: "dxw-spinner dim-spinner" }),
    h9("h3", null, scanned ? "\u5FAE\u4FE1\u5DF2\u786E\u8BA4\uFF0C\u6B63\u5728\u542F\u52A8\u6D88\u606F\u8FDE\u63A5" : "\u6B63\u5728\u51C6\u5907\u5FAE\u4FE1\u4E8C\u7EF4\u7801"),
    h9("p", null, scanned ? "\u6B63\u5728\u4FDD\u5B58\u51ED\u636E\u5E76\u9A8C\u8BC1 Harness \u4E0E\u5FAE\u4FE1\u957F\u8F6E\u8BE2\u3002" : "\u6B63\u5728\u8054\u7CFB\u817E\u8BAF\u5FAE\u4FE1 iLink \u670D\u52A1\u3002"),
    onCancel ? h9(
      "div",
...
function ProvisionError3({ provision, busy, onRetry, onClose }) {
  ...
  return h9(
    ...
    h9(
      ...
      h9("h3", null, provision.status === "expired" ? "\u4E8C\u7EF4\u7801\u5DF2\u8FC7\u671F" : "\u5FAE\u4FE1\u6CA1\u6709\u7ED1\u5B9A\u5B8C\u6210"),
      h9("p", null, error.message),
      h9("span", { className: "dxw-errorCode" }, error.code),
      h9(
        "div",
        { className: "dxw-actions dim-viewActions" },
        h9(Button11, { kind: "primary", onClick: onRetry, disabled: busy }, "\u91CD\u65B0\u751F\u6210\u4E8C\u7EF4\u7801"),
        h9(Button11, { onClick: onClose, disabled: busy }, "\u5173\u95ED")
      )
    )
  );
}
    ...
    h9(
      ...
      h9(
        ...
        h9(
          ...
          h9("div", { className: "dxw-avatar dim-botAvatar", "aria-hidden": "true" }, h9(WeixinLogoGlyph, { size: 27 })),
          h9("div", { className: "dim-botName" }, h9("h3", null, account.bot.name), h9("p", null, account.bot.accountIdMasked))
        ),
        h9(
          "div",
          { className: "dxw-health dim-botHealth" },
          h9("span", { className: "dxw-dot dim-healthDot", "data-tone": tone }),
          h9("span", null, account.connected ? "\u8FD0\u884C\u6B63\u5E38" : state === "connecting" ? "\u6B63\u5728\u8FDE\u63A5" : "\u8FDE\u63A5\u672A\u5C31\u7EEA")
        )
      ),
      h9(
        "dl",
        ...
        h9(
          ...
          h9("dt", null, "\u6D88\u606F\u901A\u9053"),
          h9("dd", null, account.connected ? "iLink \u957F\u8F6E\u8BE2" : "\u79BB\u7EBF")
        ),
        h9(
          "div",
          { className: "dxw-metric dim-botMetric" },
          h9("dt", null, "\u6700\u8FD1\u68C0\u67E5"),
          h9("dd", null, checkedTime5(account.health.lastCheckedAt))
        )
      ),
      h9(
        "div",
        { className: "dxw-accountFooter dim-cardFooter" },
        summary ? h9("div", { className: "dxw-summary dim-cardSummary" }, summary) : null,
        h9(
          "div",
          ...
          h9(Button11, { className: "dim-cardAction", kind: "danger", onClick: onRequestRemove, disabled: Boolean(busy) }, "\u79FB\u9664\u63A5\u5165")
        )
      )
    ),
    removing ? h9(
      ...
      h9("strong", null, "\u4ECE\u6B64 Harness \u79FB\u9664\u8FD9\u4E2A\u5FAE\u4FE1\u8D26\u53F7\uFF1F"),
      h9("p", null, "\u8FD9\u4F1A\u505C\u6B62\u6D88\u606F\u8FDE\u63A5\uFF0C\u5E76\u5220\u9664\u672C\u673A\u4FDD\u5B58\u7684 bot_token\u3001\u8D26\u53F7\u914D\u7F6E\u548C\u4F1A\u8BDD\u6620\u5C04\u3002\u5176\u4ED6\u5FAE\u4FE1\u8D26\u53F7\u4E0D\u53D7\u5F71\u54CD\u3002"),
      h9(
        "div",
        { className: "dxw-actions dim-viewActions" },
        h9(Button11, { onClick: onCancelRemove, disabled: busy === "delete" }, "\u4FDD\u7559\u8D26\u53F7"),
        h9(
          Button11,
...
function AccountList2(props) {
  return h9(
    "section",
    { className: "dim-listSection" },
    h9("div", { className: "dxw-listHeading dim-listHeading" }, h9("h3", null, "\u5DF2\u63A5\u5165\u7684\u5FAE\u4FE1\u8D26\u53F7")),
    h9("ul", { className: "dxw-list dim-botList" }, props.bots.map((account) => h9(
      "li",
      { key: account.botId },
      h9(AccountCard4, {
        account,
...
function WeixinSettingsTab({ rpcCall }) {
  ...
  let provisionView = null;
  if (provision?.status === "starting") {
    provisionView = h9(ProgressPanel2, { busy });
  } else if (["pending", "scanned"].includes(provision?.status)) {
    provisionView = h9(QrPanel4, {
      provision,
      now,
      busy,
      onRefresh: () => void startProvisioning({ replace: true }),
    ...
    provisionView = h9(VerificationPanel, {
      provision,
      busy,
    ...
    provisionView = h9(ProgressPanel2, {
      scanned: true,
      busy,
      onCancel: () => void cancelProvisioning()
    });
  } else if (provision && ["failed", "expired", "cancelled"].includes(provision.status)) {
    provisionView = h9(ProvisionError3, {
      provision,
      busy,
      onRetry: () => void startProvisioning({ replace: Boolean(provision.attemptId) }),
      onClose: () => void cancelProvisioning()
  ...
  return h9(
    ...
    h9("div", { className: "dxw-visuallyHidden", role: "status", "aria-live": "polite" }, notice),
    model.error && model.phase === "ready" ? h9("div", { className: "dxw-statusNotice dim-statusNotice" }, `\u72B6\u6001\u5237\u65B0\u5931\u8D25\uFF1A${model.error.message}`) : null,
    model.phase === "loading" ? h9(LoadingView5) : model.phase === "error" ? h9(
      "div",
      { className: "dxw-card dim-surfaceCard" },
      h9(
        "div",
        ...
        h9("h3", null, "\u65E0\u6CD5\u8BFB\u53D6\u5FAE\u4FE1\u72B6\u6001"),
        h9("p", null, model.error?.message ?? "\u8BF7\u7A0D\u540E\u91CD\u8BD5"),
        h9(Button11, { onClick: () => void loadStatus() }, "\u91CD\u65B0\u8BFB\u53D6")
      )
    ) : h9(
      React10.Fragment,
      null,
      provisionView,
      model.bots.length === 0 && !provision ? h9(EmptyView5, { onStart: () => void startProvisioning(), busy }) : null,
      model.bots.length > 0 ? h9(AccountList2, {
        bots: model.bots,
        busyByBot,
        removeTarget,
        onReconnect: (account) => void reconnect(account),
...
var Button13 = React11.forwardRef(function Button14({ children, kind = "secondary", className = "", ...props }, ref) {
  return h10("button", {
    ...props,
    ref,
    type: "button",
  ...
  return h10(
    ...
    h10(
      ...
      h10(
        ...
        }, h10(QrActionIcon), busy ? "\u6B63\u5728\u63A5\u5165" : "\u626B\u7801\u63A5\u5165\u673A\u5668\u4EBA")
      ),
      totals.configured > 0 ? h10(
        "div",
        { className: "ddt-badge dim-onlineBadge" },
        h10("span", null, `${totals.connected} / ${totals.configured} \u5728\u7EBF`)
      ) : null
    )
  );
}
function LoadingView6() {
  return h10("div", {
    className: "ddt-card ddt-loading dim-surfaceCard dim-loadingView",
    "aria-busy": "true"
  }, h10("div", { className: "ddt-spinner dim-spinner" }), "\u6B63\u5728\u8BFB\u53D6 WhatsApp \u673A\u5668\u4EBA\u72B6\u6001\u2026");
}
    ...
    h10(
      ...
      h10(
        ...
        h10(
          "div",
          { className: "ddt-stateLabel dim-stateLabel" },
          h10("span", { className: "ddt-dot dim-stateDot" }),
          h10("span", null, "\u5C1A\u672A\u63A5\u5165 WhatsApp \u673A\u5668\u4EBA")
        ),
        h10("h3", null, "\u626B\u7801\u7ED1\u5B9A WhatsApp \u673A\u5668\u4EBA"),
        h10("p", null, "\u4F7F\u7528\u624B\u673A WhatsApp \u626B\u63CF\u4E8C\u7EF4\u7801\u5373\u53EF\u63A5\u5165\u3002"),
        h10(
          "div",
          { className: "ddt-actions dim-viewActions" },
          h10(
    ...
    h10(
      ...
      h10(
        ...
        h10(
          ...
          }) : h10("div", { className: "ddt-qrFallback dim-qrFallback" }, "\u4E8C\u7EF4\u7801\u6B63\u5728\u751F\u6210\u2026")
        ),
        h10(
          "div",
          { className: "ddt-countdown dim-countdown" },
          h10(
            "div",
            { className: "ddt-countdownTop dim-countdownTop" },
            h10("span", null, "\u5F53\u524D\u4E8C\u7EF4\u7801\u6709\u6548\u65F6\u95F4"),
            h10("strong", null, formatRemaining6(remaining))
          ),
          h10("div", {
      ...
      h10(
        ...
        h10(
          "div",
          { className: "ddt-stateLabel dim-stateLabel" },
          h10("span", { className: "ddt-dot dim-stateDot", "data-tone": "warning" }),
          h10("span", null, "\u7B49\u5F85 WhatsApp \u626B\u7801")
        ),
        h10("h3", null, "\u7528\u624B\u673A WhatsApp \u626B\u63CF\u4E8C\u7EF4\u7801"),
        h10(
          "ol",
          { className: "ddt-steps dim-steps" },
          h10("li", null, "\u6253\u5F00 WhatsApp \u2192 \u8BBE\u7F6E \u2192 \u5DF2\u5173\u8054\u8BBE\u5907"),
          h10("li", null, "\u70B9\u51FB\u201C\u5173\u8054\u8BBE\u5907\u201D\u5E76\u626B\u63CF\u5DE6\u4FA7\u4E8C\u7EF4\u7801")
        ),
        h10(
          "div",
          { className: "ddt-actions dim-viewActions" },
          h10(Button13, { onClick: onRefresh, disabled: busy }, "\u91CD\u65B0\u751F\u6210\u4E8C\u7EF4\u7801"),
          h10(Button13, { kind: "quiet", onClick: onCancel, disabled: busy }, "\u53D6\u6D88")
        )
      )
    )
  );
...
function ProvisionView3({ provision, busy, onRetry, onClose }) {
  if (provision.status === "starting" || provision.status === "connecting") {
    ...
    return h10(
      ...
      h10("div", { className: "ddt-spinner dim-spinner" }),
      h10("h3", null, starting ? "\u6B63\u5728\u751F\u6210 WhatsApp \u4E8C\u7EF4\u7801" : "\u5DF2\u626B\u7801\uFF0C\u6B63\u5728\u8FDE\u63A5 WhatsApp"),
      h10("p", null, starting ? "\u6B63\u5728\u5EFA\u7ACB\u5B89\u5168\u7684\u5173\u8054\u8BBE\u5907\u4F1A\u8BDD\u3002" : "\u5173\u8054\u8BBE\u5907\u6B63\u5728\u63A5\u5165 DeepSeek Harness\u3002")
    );
  }
  const error = provision.error ?? {
  ...
  return h10(
    ...
    h10(
      "div",
      { className: "ddt-inlineError dim-inlineError", role: "alert" },
      h10("h3", null, "WhatsApp \u6CA1\u6709\u63A5\u5165\u5B8C\u6210"),
      h10("p", null, error.message),
      h10("span", { className: "ddt-errorCode" }, error.code),
      h10(
        "div",
        { className: "ddt-actions dim-viewActions" },
        h10(Button13, { kind: "primary", onClick: onRetry, disabled: busy }, "\u91CD\u65B0\u751F\u6210\u4E8C\u7EF4\u7801"),
        h10(Button13, { onClick: onClose, disabled: busy }, "\u5173\u95ED")
      )
    )
  );
}
function RemoveConfirmation5({ account, busy, onConfirm, onCancel }) {
  return h10(
    "div",
    { className: "ddt-confirm dim-confirm", role: "alertdialog" },
    h10("strong", null, `\u4ECE DeepSeek Harness \u79FB\u9664\u201C${account.bot.name}\u201D\uFF1F`),
    h10("p", null, "\u8FD9\u4F1A\u505C\u6B62\u6D88\u606F\u8FDE\u63A5\uFF0C\u5E76\u5220\u9664\u672C\u673A\u4FDD\u5B58\u7684 WhatsApp \u5173\u8054\u8BBE\u5907\u548C\u4F1A\u8BDD\u6620\u5C04\u3002"),
    h10(
      "div",
      { className: "ddt-actions dim-viewActions" },
      h10(Button13, { onClick: onCancel, disabled: busy }, "\u4FDD\u7559\u673A\u5668\u4EBA"),
      h10(
        Button13,
        { kind: "danger", onClick: onConfirm, disabled: busy },
        busy ? "\u6B63\u5728\u79FB\u9664\u2026" : "\u786E\u8BA4\u79FB\u9664\u63A5\u5165"
...
function WhatsappAccountCard({
  ...
  return h10(
      ...
      h10(
        ...
        h10(
          ...
          h10("div", {
            ...
            "aria-hidden": "true"
          }, h10(WhatsappLogoGlyph, { size: 29 })),
          h10(
            "div",
            { className: "dim-botName" },
            h10("h3", null, account.bot.name),
            h10("p", null, account.bot.idMasked)
          )
        ),
        h10(
          "div",
          { className: "ddt-health dim-botHealth" },
          h10("span", { className: "ddt-dot dim-healthDot", "data-tone": tone }),
          h10("span", null, stateLabel)
        )
      ),
      h10(
        "dl",
        ...
        h10(
          ...
          { className: "ddt-metric dim-botMetric" },
          h10("dt", null, "\u6D88\u606F\u901A\u9053"),
          h10("dd", null, account.connected ? "WhatsApp Web" : "\u79BB\u7EBF")
        ),
        h10(
          "div",
          { className: "ddt-metric dim-botMetric" },
          h10("dt", null, "\u6700\u8FD1\u68C0\u67E5"),
          h10("dd", null, checkedTime6(account.health.lastCheckedAt))
        )
      ),
      h10(
        "div",
        { className: "ddt-accountFooter dim-cardFooter" },
        summary ? h10("div", { className: "ddt-summary dim-cardSummary" }, summary) : null,
        h10(
          "div",
          { className: "ddt-actions dim-cardActions" },
          h10(Button13, {
    ...
    removing ? h10(RemoveConfirmation5, {
      account,
      busy: busy === "delete",
      onConfirm: onConfirmRemove,
      onCancel: onCancelRemove
...
function WhatsappSettingsTab({ rpcCall }) {
  ...
  const botList = model.bots.length > 0 ? h10(
    "section",
    { className: "dim-listSection" },
    h10(
      "div",
      { className: "ddt-listHeading dim-listHeading" },
      h10("h3", null, "\u5DF2\u63A5\u5165\u7684 WhatsApp \u673A\u5668\u4EBA")
    ),
    h10("ul", { className: "ddt-list dim-botList" }, model.bots.map((account) => h10("li", { key: account.botId }, h10(WhatsappAccountCard, {
      account,
      busy: busyByBot[account.botId],
      removing: removeTarget === account.botId,
      onReconnect: () => void botAction(
  ...
  return h10(
    ...
    model.phase === "loading" ? h10(LoadingView6) : model.phase === "error" ? h10(
      "div",
      { className: "ddt-card dim-surfaceCard" },
      h10(
        "div",
        { className: "ddt-inlineError dim-inlineError" },
        h10("h3", null, "\u65E0\u6CD5\u8BFB\u53D6 WhatsApp \u673A\u5668\u4EBA\u72B6\u6001"),
        h10("p", null, model.error?.message),
        h10(Button13, { onClick: () => void loadStatus() }, "\u91CD\u65B0\u8BFB\u53D6")
      )
    ) : h10(
      React11.Fragment,
      null,
      provision?.status === "pending" ? h10(QrPanel5, {
        provision,
        now,
        busy,
        onRefresh: () => void startProvisioning(true),
        onCancel: () => void closeProvision()
      }) : provision ? h10(ProvisionView3, {
        provision,
        busy,
        onRetry: () => void startProvisioning(true),
        onClose: () => void closeProvision()
      }) : model.bots.length === 0 ? h10(EmptyView6, { busy, onStart: () => void startProvisioning(false) }) : null,
      botList
    )
  );
}
...
function DingtalkLogo() {
  return h11(
    ...
    h11(DingtalkLogoGlyph)
  );
}
function QqLogo() {
  return h11("span", { className: "dim-logo dim-logoQq", "aria-hidden": "true" }, h11(QqLogoGlyph));
}
function WecomLogo() {
  return h11("span", { className: "dim-logo dim-logoWecom", "aria-hidden": "true" }, h11(WecomLogoGlyph));
}
function TelegramLogo() {
  return h11(
    "span",
    { className: "dim-logo dim-logoTelegram", "aria-hidden": "true" },
    h11(TelegramLogoGlyph)
  );
}
function SlackLogo() {
  return h11(
...
function WhatsappLogo() {
  return h11(
    ...
    h11(WhatsappLogoGlyph)
  );
}
function ChannelLogo({ channel: channel4 }) {
  if (channel4 === "weixin") return h11(WeixinLogo);
  if (channel4 === "feishu") return h11(FeishuLogo);
  if (channel4 === "dingtalk") return h11(DingtalkLogo);
  if (channel4 === "wecom") return h11(WecomLogo);
  if (channel4 === "qq") return h11(QqLogo);
  if (channel4 === "slack") return h11(SlackLogo);
  if (channel4 === "telegram") return h11(TelegramLogo);
  if (channel4 === "discord") return h11(DiscordLogo);
  return h11(WhatsappLogo);
}
function IMSettingsTab({
  ...
  const [selected, setSelected] = React12.useState("weixin");
  ...
  return h11(
    ...
    h11(
      "header",
      { className: "dim-title" },
      h11("p", null, "\u628A\u673A\u5668\u4EBA\u63A5\u5165 DeepSeek Harness")
    ),
    h11(
      "div",
      ...
      h11(
        ...
        CHANNELS.map((channel4) => h11(
          ...
          h11(ChannelLogo, { channel: channel4.id }),
          h11(
            "span",
            { className: "dim-channelCopy" },
            h11("strong", null, channel4.label)
          )
        ))
      ),
      h11("div", { className: "dim-divider", "aria-hidden": "true" }),
      h11("main", {
        className: "dim-panel",
        role: "tabpanel",
        id: `dim-panel-${active.id}`,
        "aria-labelledby": `dim-tab-${active.id}`
      }, active.id === "weixin" ? h11(WeixinSettingsTab, { rpcCall: weixinRpcCall }) : active.id === "feishu" ? h11(FeishuSettingsTab, { rpcCall: feishuRpcCall }) : active.id === "dingtalk" ? h11(DingtalkSettingsTab, { rpcCall: dingtalkRpcCall }) : active.id === "wecom" ? h11(WecomSettingsTab, { rpcCall: wecomRpcCall }) : active.id === "qq" ? h11(QqSettingsTab, { rpcCall: qqRpcCall }) : active.id === "slack" ? h11(SlackSettingsTab, { rpcCall: slackRpcCall }) : active.id === "telegram" ? h11(TelegramSettingsTab, { rpcCall: telegramRpcCall }) : active.id === "discord" ? h11(DiscordSettingsTab, { rpcCall: discordRpcCall }) : h11(WhatsappSettingsTab, { rpcCall: whatsappRpcCall }))
    )
  );
}
function apply(ctx) {
