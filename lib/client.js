...
function normalizeReasoning(value) {
  ...
  for (const entry of value.efforts) {
    const id5 = cleanId(entry?.id, MAX_EFFORT_ID_LENGTH);
    if (!id5 || seen.has(id5)) continue;
    seen.add(id5);
    const description = cleanLabel(entry.description, "");
    efforts.push({ id: id5, name: cleanLabel(entry.name, id5), ...description ? { description } : {} });
  }
...
function ModelEditor({ model = null, disabled = false, onSave }) {
  ...
  const row = (key, label, value, blocked = false) => h2(
    "button",
    {
      ...
      "aria-controls": pane === key ? `${id5}-menu` : void 0,
      "aria-describedby": key === "effort" && effortHint ? `${id5}-hint` : void 0,
      onClick: (event) => {
        ...
        h2(
          ...
          h2(
            "button",
            {
              ...
              className: "dim-presetHelpButton",
              "aria-label": "\u67E5\u770B\u6A21\u578B\u8BBE\u7F6E\u8BF4\u660E",
              "aria-describedby": `${id5}-help`
            },
            h2("span", { "aria-hidden": true }, "?")
          ),
          h2(
            "span",
            { id: `${id5}-help`, className: "dim-presetTooltip", role: "tooltip" },
            "\u53EA\u5F71\u54CD\u65B0\u5EFA\u4F1A\u8BDD\uFF1B\u82E5\u5F53\u524D\u804A\u5929\u5DF2\u6709\u4F1A\u8BDD\uFF0C\u5148\u53D1\u9001 /new\uFF0C\u518D\u53D1\u9001\u666E\u901A\u6D88\u606F\u751F\u6548\u3002"
          )
        )
      ),
...
function StepPushEditor({ value = false, mode = "post", disabled = false, onSave, onModeSave }) {
  ...
  const helpText = current === "off" ? "\u5173\u95ED\u65F6\u4F7F\u7528\u539F\u751F\u6D41\u5F0F\u5361\uFF0C\u53EA\u5C55\u793A\u6700\u7EC8\u7B54\u6848\uFF1B\u5F00\u542F\u540E\u53EF\u9010\u6B65\u67E5\u770B\u6267\u884C\u8FC7\u7A0B" : current === "streaming_card" ? "\u601D\u8003\u4E0E\u5DE5\u5177\u6458\u8981\u6298\u53E0\u5C55\u793A\uFF0C\u6700\u7EC8\u7B54\u6848\u5728\u540C\u4E00\u5F20\u5361\u7247\u4E2D\u539F\u5730\u5237\u65B0" : "\u6BCF\u4E00\u6B65\u5DE5\u5177\u8C03\u7528\u4E0E\u8FC7\u7A0B\u8BF4\u660E\u5404\u63A8\u4E00\u6761\u5BCC\u6587\u672C\u6D88\u606F\uFF0C\u6700\u7EC8\u7B54\u6848\u5355\u72EC\u6295\u9012";
  return h2(
    "section",
    {
    ...
    h2(
      ...
      h2("option", { value: "off" }, "\u5173\u95ED\uFF08\u539F\u751F\u6D41\u5F0F\u5361\uFF0C\u53EA\u770B\u6700\u7EC8\u7B54\u6848\uFF09"),
      h2("option", { value: "post" }, "\u9010\u6761\u6D88\u606F\uFF08\u6BCF\u6B65\u4E00\u6761\u5BCC\u6587\u672C\u6D88\u606F\uFF09"),
      h2("option", { value: "streaming_card" }, "zcode\u8FC7\u7A0B\u5361\uFF08\u5355\u5361\u539F\u5730\u5237\u65B0\uFF09")
    ),
